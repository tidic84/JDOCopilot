...
import {defaultCSS} from "../stylesheets/_default/login"; //first theme
          ...
          <View style={defaultCSS.container}>
            ...
            {/* <View >
              <TouchableWithoutFeedback onPress={onShowPopup}>
                <Ionicons name="color-palette-outline" size={24} color='#FFF' style={defaultCSS.themeSelector}/>
            ...
            <View style={{ marginHorizontal: 32 }}>
              <Text style={defaultCSS.header}>Connectez-vous !!!</Text>
              <View style={defaultCSS.separator} />


              <TextInput defaultValue={this.state.keptName} autoComplete="username" style={defaultCSS.textInput} placeholder="Nom d'utilisateur" 
              ...
              <TextInput defaultValue={this.state.keptPassword} autoComplete="password" secureTextEntry={true} style={defaultCSS.textInput} placeholder="Mot de passe" 
                onChangeText={pwd => {
                  this.setState({ pwd })
                }}
              ...
              <View style={{ alignItems: "flex-end", marginTop: 64 }}>
                <TouchableOpacity disabled={this.state.disabledButton} activeOpacity={0.6} style={defaultCSS.continue} onPress={this.continue}>
            ...
            <View style={defaultCSS.bottomContainer}>
              <View style={defaultCSS.bottomBox}>
                <Text style={defaultCSS.basicText}>Si vous avez oublié vos identifiants, rien de grave, réinitialisez-le directement via Atrium! JDO-Copilot ne stock aucunes données personnelles.</Text>
              </View>
            </View>
          </View>
