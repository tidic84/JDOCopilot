...
export default class LoginWithoutFastCo extends React.Component {
        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}
          ...
          <View style={defaultCSS.container}>
            ...
            <View style={{ marginHorizontal: 32 }}>
              <Text style={defaultCSS.header}>Re-Bonjour !</Text>
              <Text style={defaultCSS.underHeader}>Reconnectez-vous pour rafraîchir vos données</Text>
